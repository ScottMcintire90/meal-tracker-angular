...
@Component({
  ...
  template:`
    <div class="meal-form">
      ...
      <label class="col-sm-6" for="newCalories">Calories</label><input class="col-sm-6 input-lg cd-form" #newCalories>
...
export class NewMealComponent {
  ...
  addMeal(newName: HTMLInputElement, newDetails: HTMLInputElement, newCalories: HTMLInputElement) {
    ...
    } else if(Number(newCalories.value === null)){
      alert("Please give the meal a calorie count.")
    } else {
